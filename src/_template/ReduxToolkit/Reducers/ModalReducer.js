...
export const { IS_MODAL, IS_OFFSET, OVERLAY, CLOSEOVERLAY, RESETOVERLAY, TOPMENUTOGGLE, STARTMODAL, LOGINMODAL, OPENLOGINMODAL, CLOSELOGINMODAL, ISCARTADD, SIZEMODAL, CATEGORYRESPONSIVE, ISPROFILEMODAL, PAYMENTCARDMODAL, SAVEADDRESSMODAL, NOTIFICATIONALTER, YOUTUBEMODAL, ISDASHBOARD, OPENDELETEMODAL, CONFIRMDELETE, CONFIGMODAL, PRODUCTPAGEFILTER } = ModalReducer.actions;
