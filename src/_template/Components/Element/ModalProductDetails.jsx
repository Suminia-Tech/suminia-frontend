...
import { Brand, Category, Color, Size, Tags, Viewdetails, productdetail } from "@/_template/Constant";
import AddtoCartBtn from "./AddtoCartBtn";
import DynamicRating from "./DynamicRating";
import KGSelector from "./KGSelector";
import HomeProductDetails from "./HomeProductDetails";
import { IS_MODAL } from "@/_template/ReduxToolkit/Reducers/ModalReducer";
    ...
    <Col lg="6">
      <div className="product-right">
        ...
        <div className="product-btns">
          ...
          <Link href={`/product/product_left_thumbnail/${data?.id}`} className="btn btn-solid-default btn-sm" onClick={() => dispatch(IS_MODAL())}>
            {Viewdetails}
          </Link>
        </div>
      </div>
