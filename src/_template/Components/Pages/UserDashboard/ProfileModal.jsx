...
import { Close, ComfirmEmailaddress, ConfirmEmail, EmailAddress, Password, Savechanges } from "@/_template/Constant";
import { ISPROFILEMODAL } from "@/_template/ReduxToolkit/Reducers/ModalReducer";
const ProfileModal = () => {
